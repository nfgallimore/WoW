...
L["Can't run a GetAll scan right now."] = "Kann im Moment keinen GetAll Scan durchführen." -- Needs review
L["Descending"] = "Absteigend"
L["Display lowest buyout value seen in the last scan in tooltip."] = "Zeige den niedrigsten Sofortkauf-Betrag aus dem letzten Scan im Tooltip." -- Needs review
L["Display market value in tooltip."] = "Zeige Marktwert im Tooltip." -- Needs review
L["Display number of items seen in the last scan in tooltip."] = "Zeige Anzahl der gefundenen Gegenstände im letzten Scan im Tooltip." -- Needs review
L["Display total number of items ever seen in tooltip."] = "Zeige Gesamtzahl der je gefundenen Gegenstände im Tooltip." -- Needs review
L["Done Scanning"] = "Scannen beendet"
L["Download the FREE TSM desktop application which will automatically update your TSM_AuctionDB prices using Blizzard's online APIs (and does MUCH more). Visit %s for more info and never scan the AH again! This is the best way to update your AuctionDB prices."] = "Lade die KOSTENLOSE TSM Desktopsoftware herunter die automatisch deine TSM_AuctionDB mit den Preisen aus Blizzard's online API aktualisiert (und noch VIEL mehr kann). Besuche %s für weitere Informationen und scanne das AH nie wieder! Dies ist die beste Art deine AuctionDB Preise aktuell zu halten." -- Needs review
L["Enable display of AuctionDB data in tooltip."] = "Aktiviere die Anzeige der AuctionDB-Daten im Tooltip."
L["GetAll scan did not run successfully due to issues on Blizzard's end. Using the TSM application for your scans is recommended."] = "GetAll scan nicht erfolgreich aufgrund von Problemen bei Blizzard. Nutzung der TSM Software für deinen Scan wird empfohlen." -- Needs review
...
L["If checked, the lowest buyout value seen in the last scan of the item will be displayed."] = "Wenn ausgewählt wird der niedrigeste Sofortkaufpreis der im letzten Scan gefunden wurde angezeigt." -- Needs review
L["If checked, the market value of the item will be displayed"] = "Wenn ausgewählt wird der Marktwert des Gegenstands angezeigt." -- Needs review
L["If checked, the number of items seen in the last scan will be displayed."] = "Wenn ausgewählt wird die Anzahl der gefundenen Gegestände im letzten Scan angezeigt." -- Needs review
L["If checked, the total number of items ever seen will be displayed."] = "Wenn ausgewählt wird die Anzahl der jemals gefundenen Gegenstände angezeigt." -- Needs review
L["Imported %s scans worth of new auction data!"] = "%s Scans mit neuen Auktionsdaten importiert!" -- Needs review
...
L["Last updated from in-game scan %s ago."] = "Zuletzt aktualisiert durch in-game-Scan vor %s" -- Needs review
L["Last updated from the TSM Application %s ago."] = "Zuletzt aktualisiert durch TSM-Applikation vor %s" -- Needs review
L["Market Value"] = "Marktwert"
L["Market Value:"] = "Marktwert:" -- Needs review
L["Market Value x%s:"] = "Marktwert x%s:" -- Needs review
...
L["Result Order:"] = "Reihenfolge der Ergebnisse:" -- Needs review
L["Run Full Scan"] = "Starte einen vollen Scan"
L["Run GetAll Scan"] = "Starte Komplettscan"
L["Running query..."] = "Abfrage läuft..." -- Needs review
L["%s ago"] = "Vor %s"
L["Scanning page %s/%s"] = "Scanne Seite %s/%s" -- Needs review
L["Scanning the auction house in game is no longer necessary!"] = "In-Game-Scan des Auktionshauses ist nicht mehr nötig!" -- Needs review
L["Search"] = "Suche"
...
L["Select whether to sort search results in ascending or descending order."] = "Wähle, ob die Suchergebnisse aufsteigend oder absteigend sortiert werden sollen." -- Needs review
